        	...
        	/***********ĐH, CĐ Lân cận*************/
	        	function search_nearby_item(item) {
					...
					$(".near_by_item").click(function() {	
							...
							if ($(".near_by_item").val() == "CĐ, ĐH gần nhất"){
...
$(".position.item2").on("click",function(){
        ...
        function search_nearby_item2(item) {
			...
			$(".near_by_item2").click(function() {	
							document.getElementById('places2').innerHTML = "";
							if ($(".near_by_item2").val() == "CĐ, ĐH gần nhất"){
								search_nearby_item2("university")
							}
							else if ($(".near_by_item2").val() == "Điểm buýt"){
								search_nearby_item2("bus_station")
							}
							else if ($(".near_by_item2").val() == "Bệnh viện"){
								search_nearby_item2("hospital")
							}
							else if ($(".near_by_item2").val() == "Bãi gửi xe"){
								search_nearby_item2("parking")
							}
						})
    	};
