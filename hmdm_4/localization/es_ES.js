...
document.localization ['es_ES'] = {
    ...
    'devices.settings.conformance.broken': 'Problema de configuracion: (${serverData})',
    ...
    'button.app.settings': 'Configuracion de la Aplicacion',
    'button.ok': 'OK',
    'button.help': 'Ayuda',
    ...
    'button.set.configuration': 'Definir configuracion',
    ...
    'question.delete.configuration': 'Elminar configuracion "${configurationName}"??',
    'question.delete.group': 'Eliminar grupo "${groupName}"?',
    'question.delete.device': 'Elminar dispositivo con numero "${deviceNumber}"?',
    ...
    'error.empty.configuration': 'Especifique la configuracion',
    'error.empty.configuration.name': 'Ingrese el nombre de la configuracion',
    ...
    'error.empty.customer.device.configuration': 'Seleccione una configuracion',
    ...
    'error.duplicate.configuration.name': 'La configuracion con el nombre elegido ya existe. Intente un nombre diferente.',
    'error.duplicate.device.number': 'Ya existe un dispositivo con este numero',
    ...
    'error.configuration.device.use': 'No puede eliminar esta configuracion, esta en uso en dispositivos. Primero dirijase a "Dispositivos" y cambie su configuracion',
    'error.invalid.system.update.time': 'Intervalo de instalacion invalido',
    ...
    'error.duplicate.device': 'Ya existe un dispositivo con el mismo numero',
    ...
    'error.application.config.reference.exists': 'La aplicacion esta siendo usada en configuraciones y no puede eliminarse',
    ...
    'error.duplicate.configuration': 'Ya existe una configuracion con este nombre',
    ...
    'success.settings.design.saved': 'Configuracion de diseño guardada satisfactoriamente',
    'success.settings.common.saved': 'Configuracion de tabla de dispositivos guardada satisfactoriamente',
    ...
    'success.configuration.saved': 'Configuracion guardada satisfactoriamente',
    'success.operation.completed': 'Operacion completada satisfactoriamente',
    'success.plugins.disabled': 'Configuracion guardada satisfactoriamente',
    'success.config.update.notification': 'La actualizacion de configuracion fue enviada a los dispositivos.',
    'success.config.update.device.app.settings.notification': 'La actualizacion de configuracion fue enviada al dispositivo',

    'form.icon.title': 'Icono',
    'form.icon.name': 'Nombre',
    'form.icon.file': 'Archivo',

    'form.configuration.title': 'Configuracion',
    'form.configuration.title.typical': 'Configuracion tipica',
    ...
    'form.configuration.settings.system.update.time': 'Tiempo de instalacion',
    ...
    'form.configuration.settings.common.name.placeholder': 'Ingrese el nombre de la configuracion',
    'form.configuration.settings.common.desc': 'Descripcion',
    'form.configuration.settings.common.desc.placeholder': 'Ingrese la descripcion de la configuracion',
    ...
    'form.configuration.settings.use.default.launcher': 'Usar con el launcher por defecto',
    ...
    'form.application.run.after.install': 'Correr luego de la instalacion',
    ...
    'form.application.configurations.configs': 'Configuracion',

    'form.configuration.copy.new.name': 'Nuevo nombre',
    'form.configuration.copy.new.name.placeholder': 'Ingrese el nuevo nombre de configuracion',
    ...
    'form.customer.prefix.placeholder': 'Ingrese el prefijo de numero de dispositivo',
    'form.customer.device.configuration': 'Configuracion del Dispositivo',
    ...
    'form.device.config': 'Configuracion',
    'form.device.imei': 'IMEI',
    'form.device.phone.number': 'Numero Telefonico',

    'form.update.device.config': 'Configuracion',
    ...
    'form.settings.misc.phone.format': 'Formato del numero telefonico',
    ...
    'form.settings.misc.custom.property.name.2': 'Propiedad personalizad #2',
    'form.settings.misc.custom.property.name.3': 'Propiedad personalizad #3',
    ...
    'form.settings.misc.new.device.config': 'Nuevo configuracion de dispositivo',
    ...
    'search.placeholder.configuration': 'Buscar configuracion',
    ...
    'table.heading.device.phone.number': 'Numero Telefonico',
    'table.heading.device.phone.model': 'Modelo Telefono',
    'table.heading.device.status.permissions': 'Estado Permisos',
    'table.heading.device.status.installation': 'Estado Instalacion',
    ...
    'about.line.1': 'FDS MDM panel de control',
    ...
    'qrcode.help.line5': 'Este QR debe contener el ID del dispositivo de FDS MDM (no necesitas ingresarlo en el dispositivo). Para agregar la ID del dispositivo al QR, ingresa la ID del dispositvo y presiona "Renovar".',
    ...
    'form.configuration.app.version.select.upgrade.warning': 'Actualizar aplicacion "${v1}" a la version version "${v3}" para configuracion "${v2}"?',
    ...
    'form.devices.label.installation.status': 'Estado de Instalacion',
    "format.devices.date.createTime": "dd/MM/yyyy HH:mm:ss",
    "format.devices.date.datePicker": "dd-MM-yyyy",

    'form.devices.selection.install.status.default': 'Estado de instalacion ...',
