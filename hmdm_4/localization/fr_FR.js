...
'form.profile.title': 'Changer le mot de passe',
    ...
    'about.line.1': 'Panneau de configuration FDS MDM',
    ...
    'qrcode.help.line5': 'Le code QR peut contenir ID de l\'appareil pour FDS MDM (pas besoin de le saisir sur un appareil mobile). Pour intégrer ID de l\'appareil dans le code QR, saisissez ID de l\'appareil sur cet écran et cliquez sur "Renouveler".',
    ...
    'ie.browser.notice.2': 'Navigateur recommandé pour l\'utilisation de FDS MDM - <a href="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop"> Chrome < / a>.',
