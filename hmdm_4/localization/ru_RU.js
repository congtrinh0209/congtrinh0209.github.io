...
document.localization[ 'ru_RU' ] = {
    ...
    'app.title': 'FDS MDM - панель управления',
    ...
    'about.line.1': 'Панель управления FDS MDM',
    ...
    'qrcode.help.line5': 'Код может содержать также ID устройства в системе FDS MDM (после настройки его не нужно будет вводить). Для включения ID устройства в QR код, введите его на этом экране и нажмите "Обновить".',
    ...
    'ie.browser.notice.2': 'Рекомендуемый браузер для использования FDS MDM - <a href="https://support.google.com/chrome/answer/95346?co=GENIE.Platform%3DDesktop">Chrome</a>.',
