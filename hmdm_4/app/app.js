angular.module('headwind-kiosk',
    ...
    .constant("LOCALIZATION_BUNDLES", ['vi', 'en_US', 'ru_RU', 'fr_FR', 'ar_AE', 'es_ES'])
    .constant("APP_VERSION", "3.28.4") // Update this value on each commit
    .constant("ENGLISH", "en_US")
    .constant("VIETNAM", "vi")
    .provider('getBrowserLanguage', function (VIETNAM, SUPPORTED_LANGUAGES) {
        this.f = function () {
