            ...
            <v-col cols="12" md="4" class="mt-2">
                <v-card class="pt-4">
                    <div class="d-flex align-center flex-column">
                        ...
                        <h4 class="title-page px-2">{{thongTinCongDan['tenGoi']}}</h4>
                        ...
                        <div class="d-flex justify-space-between w-full pb-4 " v-if="thongTinCongDan && thongTinCongDan['danhTinhDienTu'][0]">
                          <v-btn v-if="thongTinCongDan['danhTinhDienTu'][0]['tenDinhDanh'] != thongTinCongDan['maSoDoanhNghiep']" color="primary" small class="mt-3 mx-1 px-2 text-white" @click="showChangeAcc()">
          ...
          <v-card>
            ...
            >
                ...
                <template v-slot:item.activityCode="{ item }">
                    <div class="" :style="getLogActionName(item.activityCode)['color']">
