        ...
        <v-row align-content="center">
            ...
            <v-col v-if="!advanceSearch" cols="12" md="4" class="my-0 py-0 mb-2">
                ...
                <v-text-field
                    ...
                    clearable
                    hide-details="auto"
                    placeholder="Nhập tên, mã tổ chức, doanh nghiệp"
                    @keyup.enter="getDanhMuc()"
                ></v-text-field>
            </v-col>
            <v-col v-if="advanceSearch" cols="12" md="4" class="my-0 py-0">
                <label>Tên tổ chức, doanh nghiệp</label>
                <v-text-field
                    class="input-form mt-2"
            ...
            <v-row v-if="advanceSearch" align-content="center" class="mx-0 my-0">
              ...
              <v-col cols="12" md="4" class="my-0 py-0">
                  <label>Mã tổ chức, mã số thuế doanh nghiệp</label>
                  <v-text-field
                      class="input-form"
              ...
              <v-col cols="12" md="4" class="py-0 mb-2">
                  <label>Địa chỉ hoạt động: Tỉnh/ thành</label>
                  <v-autocomplete
      ...
      getDanhMuc (type) {
        ...
        let filter = {
          ...
          data: {
            ...
            // diaChiHoatDong_soNhaChiTiet: vm.diaChiHoatDongCuThe
          }
        }
