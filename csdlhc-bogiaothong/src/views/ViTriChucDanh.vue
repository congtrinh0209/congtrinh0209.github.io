    ...
    <div>
      ...
      <v-row justify="center" class="mt-0">
        ...
        <v-col cols="12" md="6" class="d-flex align-center">
          <v-btn color="primary" small class="mx-0 text-white" @click="showAddChucVu">
            <v-icon size="18">mdi-plus</v-icon>&nbsp;
            Thêm mới
          </v-btn>
        </v-col>
        <v-col cols="12" md="6" class="d-flex align-center justify-end">
          <v-btn color="primary" small class="mx-0 text-white" @click="getChucVu('reset')">
          ...
          <div>
            <v-tooltip top>
              <template v-slot:activator="{ on, attrs }">
                <v-btn @click.stop="showEditChucVu(item)" color="#025e29" text icon class=" mr-3" v-bind="attrs" v-on="on">
    ...
    >
      <v-card>
        ...
        <v-card-actions class="justify-end pb-3">
          ...
          <v-btn v-if="typeAction === 'create'" class="mr-2" color="primary" :loading="loading" :disabled="loading" @click="submitAddChucVu">
            <v-icon left>
              mdi-content-save
            </v-icon>
            <span>Thêm mới</span>
          </v-btn>
          <v-btn v-else class="mr-2" color="primary" :loading="loading" :disabled="loading" @click="submitUpdateChucVu">
            <v-icon left>
              mdi-content-save
            </v-icon>
            <span>Cập nhật</span>
