...
<#assign mobile = theme_display.getThemeSetting('m_mobile')/>
<#if mobile == ''>
	<#assign mobile = '0915.421.729'/>
<#else>
	<#assign mobile = theme_display.getThemeSetting('m_phone')/>
</#if>

<#assign email = theme_display.getThemeSetting('m_email')/>
<#if email == ''>
	<#assign email = 'dichvucong@bvhttdl.gov.vn'/>
<#else>
	<#assign email = theme_display.getThemeSetting('m_email')/>
</#if>
