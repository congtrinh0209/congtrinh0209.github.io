...
<body class="${css_class} page-theme">
			...
			<div class="cont">
				<div class="mLogo align-middle"> 
					<a href="${site_default_url}"> 
						<img src="${themeDisplay.getPathThemeRoot()}/images/logo-with-text.png"> 
					</a>
				</div>
	...
	<script type="text/javascript">		
		$(document).ready(function() {
			...
			$(".header_login .logo img").attr("src","o/bancycp-theme/images/logo-login.png");
	...
	<style>
		...
		.body_login {
			background: url("/o/bancycp-theme/images/bg-login.jpg") center center no-repeat;
		...
		.page-theme #banner {
			background: url("/o/bancycp-theme/images/bg-header.jpg") left top no-repeat;
			background-size: cover;
			padding-top: 15px;
			padding-bottom: 15px;
		}
		...
		#navigation .selected a, #navigation li:hover a {
			background: url("/o/tinhdongthap-theme/images/nav.jpg") left top repeat-x;
			background-size: auto 100%;
			font-weight: bold;
		}
