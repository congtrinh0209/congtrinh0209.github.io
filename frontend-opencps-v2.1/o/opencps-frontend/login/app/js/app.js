...
(function (e) {
  function t(t) {
    for (var i, s, r = t[0], l = t[1], d = t[2], p = 0, u = []; p < r.length; p++) {
      s = r[p], o[s] && u.push(o[s][0]), o[s] = 0;
    }for (i in l) {
      Object.prototype.hasOwnProperty.call(l, i) && (e[i] = l[i]);
    }c && c(t);while (u.length) {
      u.shift()();
  ...
  }, s.p = "/";var r = window["webpackJsonp"] = window["webpackJsonp"] || [],
      l = r.push.bind(r);r.push = t, r = r.slice();for (var d = 0; d < r.length; d++) {
    t(r[d]);
    ...
    a.r(t);a("0f18");var i = a("a026"),
      ...
      var e = this,
          t = e.$createElement,
          a = e._self._c || t;return a("div", { staticClass: "v-btn__content" }, [a("i", { staticClass: "v-icon swing animated material-icons theme--light blue--text text--darken-3", staticStyle: { "font-size": "20px", animation: "swing 0.8s ease 0s infinite normal none running" }, attrs: { "aria-hidden": "true" } }, [e._v("notifications_active")])]);
    }],
        r = a("bc3a"),
        l = a.n(r),
        d = a("854a"),
      ...
      var e = this,
          t = e.$createElement,
          a = e._self._c || t;return null !== e.template_default && void 0 !== e.template_default && "undefined" !== e.template_default ? a("my-dynamic-view") : e._e();
    },
        u = [],
        m = a("da1e"),
        g = m["a"],
        ...
        var e = this;e.$nextTick(function () {
          e.isSignedIn = window.themeDisplay.isSignedIn(), e.userNameLogin = window.themeDisplay.getUserName(), e.colorBG = e.intToRGB(e.hashCode(e.userNameLogin));var t = window.themeDisplay.getLayoutRelativeURL().substring(0, window.themeDisplay.getLayoutRelativeURL().lastIndexOf("/"));e.forgottenURLStr = "" !== t ? t + "/register/#/cap-lai-mat-khau" : window.themeDisplay.getURLHome() + "/register/#/cap-lai-mat-khau", e.isSignedIn && (e.userData = {}, e.pullNotificationCount(), setTimeout(function () {
            l.a.get("/o/v1/opencps/users/" + window.themeDisplay.getUserId()).then(function (t) {
              e.userData = t.data;var a = { className: "org.opencps.usermgt.model.Applicant" === e.userData["className"] ? "org.opencps.usermgt.model.ApplicantAvatar" : e.userData["className"], classPK: e.userData["classPK"] };e.getImageAvatar(a), e.userNameLogin = e.userData["userName"], e.colorBG = e.intToRGB(e.hashCode(e.userNameLogin));
            }).catch(function (t) {
              e.avatarURL = "";
            });
          }, 1e3));
      ...
      watch: { $route: function $route(e, t) {
        ...
        getImageAvatar: function getImageAvatar(e) {
          var t = this,
            ...
            if (e.data) {
              var _a = String(e.data);t.avatarURL = window.themeDisplay.getPortalURL() + _a;
            } else t.avatarURL = "";
          }).catch(function (e) {
            t.avatarURL = "";
          });
        ...
        goToDangNhap: function goToDangNhap() {
          var e = this;l.a.post("/o/v1/opencps/login", {}, { headers: { Authorization: "BASIC " + window.btoa(e.userName + ":" + e.passWord) } }).then(function (e) {
            if ("" !== e.data && "ok" !== e.data && "captcha" !== e.data) {
              if ("pending" === e.data) {
                var _e3 = window.themeDisplay.getSiteAdminURL().split("/~")[0].replace("group", "web");window.location.href = _e3 + "/register#/xac-thuc-tai-khoan?active_user_id=" + window.themeDisplay.getUserId() + "&redirectURL=" + _e3;
              } else window.location.href = e.data;
            } else if ("ok" === e.data) window.location.href = window.themeDisplay.getURLHome();else if ("captcha" === e.data) {
              var _e4 = window.themeDisplay.getLayoutRelativeURL().substring(0, window.themeDisplay.getLayoutRelativeURL().lastIndexOf("/"));window.location.href = "" !== _e4 ? _e4 + "/register#/login" : window.themeDisplay.getURLHome() + "/register#/login";
            } else c.a.error("Tên đăng nhập hoặc mật khẩu không chính xác.");
          }).catch(function (e) {
    ...
    var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("a026");__webpack_exports__["a"] = { props: { item: { type: Object, default: function _default() {
        ...
        }, layout_view: { type: Object }, template_default: { type: Object } }, created: function created() {
        var vm = this,
            template = "",
            data = "{}",
            created = "{}",
            updated = "{}",
            methods = "{}";null !== vm.layout_view && void 0 !== vm.layout_view && "undefined" !== vm.layout_view && "" !== vm.layout_view ? vue__WEBPACK_IMPORTED_MODULE_0__["a"].component("my-dynamic-view", { template: vm.layout_view["template"], data: eval(" ( " + vm.layout_view["data"] + " ) "), created: eval(" ( " + vm.layout_view["created"] + " ) "), updated: eval(" ( " + vm.layout_view["updated"] + " ) "), methods: vm.layout_view["methods"] }) : null !== vm.template_default && void 0 !== vm.template_default && "undefined" !== vm.template_default && vue__WEBPACK_IMPORTED_MODULE_0__["a"].component("my-dynamic-view", { template: vm.template_default["template"], data: eval(" ( " + vm.template_default["data"] + " ) "), created: eval(" ( " + vm.template_default["created"] + " ) "), updated: eval(" ( " + vm.template_default["updated"] + " ) "), methods: vm.template_default["methods"] });
      },
      methods: {
        markReadEventId: function markReadEventId(e, t, a, i) {
          var o = this,
              n = { eventId: e, viewRootURI: t, dossierId: a, originality: i };o.$emit("mark-as-read", n);
        }
      } };
  } });
